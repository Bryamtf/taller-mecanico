...
class PDFService {
  constructor() {
    this.empresa = {
      nombre: "GRUPO AUTONORT PERU SAC",
      ruc: "20612370932",
      direccion:
        "AV. PROLONGACION CIEZA DE LEON MZA. 30 LOTE: 10 URB. LA PURISIMA - CHICLAYO- LAMBAYEQUE",
      telefono: "(074) 234-5678",
  ...
  <div class="info-row">
    ...
    <div class="cotizacion-box">
      ...
      <table>
        ...
        <tr>
          <td>FECHA:</td>
          <td>${this.escaparHTML(cotizacion.fecha_emision)}</td>
        </tr>
        <tr>
          <td>MONEDA:</td>
          <td>SOLES</td>
